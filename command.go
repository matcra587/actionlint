...
Documents:
  ...
  - List of checks: https://github.com/matcra587/actionlint/tree/%s/docs/checks.md
  - Usage:          https://github.com/matcra587/actionlint/tree/%s/docs/usage.md
  - Configuration:  https://github.com/matcra587/actionlint/tree/%s/docs/config.md
