...
function usage() {
    ...
    echo 'https://github.com/matcra587/actionlint/releases' >&2
    echo >&2
    echo 'DIR:' >&2
...
# https://github.com/matcra587/actionlint/releases/download/v1.0.0/actionlint_1.0.0_linux_386.tar.gz
file="actionlint_${version}_${os}_${arch}.${ext}"
url="https://github.com/matcra587/actionlint/releases/download/v${version}/${file}"
